            ...
            if (cookies != null) {
                ...
                if("".equals(user.getU_id())){
                    ...
                    try {
                        ...
                        log.info("往前台发送！");
                        String result="";
                        result= new String("u_name:"+user1.getU_name()+"#u_money:"+
                                user1.getU_money()+"#u_diamond:"+user1.getU_diamond()
                                +"#u_type:"+user1.getU_type()+"#u_icon:"+user1.getU_icon()
                                +"#u_vitality:"+user1.getU_vitality()+"#u_grade:"+user1.getU_grade());//返回user json对象
                        log.info(result);
                        return result;
                    }
                    catch (Exception e){
